...
- ### Other tools:
    ...
    + [Django-phonenumber-field](https://pypi.org/project/django-phonenumber-field/): A Django library that interfaces with python-phonenumbers to validate, pretty print and convert phone numbers.
...
| **Products**     |                        |                  |      |             |
| 1           | Logged-in user enters products URL | Product List renders all products as an array of objects. Users can create a product in the form rendered in the browser. | Y |          |
